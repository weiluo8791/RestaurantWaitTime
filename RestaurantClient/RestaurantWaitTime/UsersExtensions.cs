...
namespace RestaurantClient
{
    public static partial class UsersExtensions
    {
        ...
        /// Reference to the RestaurantClient.IUsers.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<RestaurantClient.Models.User> result = await operations.GetUserByUseridWithOperationResponseAsync(userId, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<RestaurantClient.Models.User> result = await operations.PostUserByUserWithOperationResponseAsync(user, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
