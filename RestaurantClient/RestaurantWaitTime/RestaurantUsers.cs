...
namespace RestaurantClient
{
    internal partial class RestaurantUsers : IServiceOperations<RestaurantWaitTime>, IRestaurantUsers
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<RestaurantUser>> GetCurrentRestaurantUserWithOperationResponseAsync(CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
            bool shouldTrace = ServiceClientTracing.IsEnabled;
            string invocationId = null;
            if (shouldTrace)
            {
                invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                ServiceClientTracing.Enter(invocationId, this, "GetCurrentRestaurantUserAsync", tracingParameters);
            }
            
            // Construct URL
            string url = "";
            url = url + "/api/GetCurrentRestaurantUser";
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
            {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<RestaurantUser>> GetRestaurantUserByIdByUseridWithOperationResponseAsync(string userId, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (userId == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "GetRestaurantUserByIdByUseridAsync", tracingParameters);
            }
            
            // Construct URL
            string url = "";
            url = url + "/api/GetRestaurantUserById/";
