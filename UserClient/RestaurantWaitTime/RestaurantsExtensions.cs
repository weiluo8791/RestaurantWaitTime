...
namespace UserClient
{
    public static partial class RestaurantsExtensions
    {
        ...
        {
            Microsoft.Rest.HttpOperationResponse<UserClient.Models.Restaurant> result = await operations.DeleteRestaurantByRestaurantidWithOperationResponseAsync(restaurantId, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<UserClient.Models.Restaurant> result = await operations.GetRestaurantByRestaurantidWithOperationResponseAsync(restaurantId, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
