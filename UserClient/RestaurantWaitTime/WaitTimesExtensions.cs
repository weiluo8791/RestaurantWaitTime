...
namespace UserClient
{
    public static partial class WaitTimesExtensions
    {
        ...
        {
            Microsoft.Rest.HttpOperationResponse<UserClient.Models.WaitTime> result = await operations.DeleteCurrentWaitTimeByRestaurantidAndGroupWithOperationResponseAsync(restaurantId, group, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<UserClient.Models.WaitTime> result = await operations.GetLatestRestaurantWaitTimeByGroupByRestaurantidAndGroupWithOperationResponseAsync(restaurantId, group, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<UserClient.Models.WaitTime> result = await operations.GetLatestRestaurantWaitTimeByRestaurantidWithOperationResponseAsync(restaurantId, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<UserClient.Models.WaitTime> result = await operations.PostWaitTimeByItemWithOperationResponseAsync(item, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
    }
}
